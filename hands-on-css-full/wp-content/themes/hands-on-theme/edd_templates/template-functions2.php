	...
	<form id="<?php echo $form_id; ?>" class="edd_download_purchase_form" method="post">
		...
		<div class="edd_purchase_submit_wrapper">
			...
			<?php if ( edd_display_tax_rate() && edd_prices_include_tax() ) {
				echo '<span class="edd_purchase_tax_rate">' . sprintf( __( 'Includes %1$s&#37; tax if in Australia', 'edd' ), edd_get_tax_rate() * 100 ) . '</span>';
			} elseif ( edd_display_tax_rate() && ! edd_prices_include_tax() ) {
				echo '<span class="edd_purchase_tax_rate">' . sprintf( __( 'Excluding %1$s&#37; tax if in Australia', 'edd' ), edd_get_tax_rate() * 100 ) . '</span>';
			} ?>
